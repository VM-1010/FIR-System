(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    var cards = Array.prototype.slice.call(document.querySelectorAll(".stat-card, .admin-card"));
    var actions = Array.prototype.slice.call(document.querySelectorAll(".quick-action"));
    var panels = Array.prototype.slice.call(document.querySelectorAll(".panel-card"));

    animateIn(cards.concat(actions).concat(panels));
    addHoverLift(actions);
    wireModalClose("adminConfirmModal", ["adminConfirmNoBtn", "adminConfirmYesBtn"]);
  });
})();
